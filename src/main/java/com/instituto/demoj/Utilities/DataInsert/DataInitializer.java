...
// import
// com.instituto.demoj.Permission.Persistence.Repositoty.PermissionRepository;
...
// @Transactional
// public void insertRoles(RoleRepository roleRepository, PermissionRepository
// permissionRepository) {

// PermissionEntity readPermission =
// permissionRepository.findByPermiso("READ_PRIVILEGE").orElseThrow();
// PermissionEntity qualifyPermission =
// permissionRepository.findByPermiso("QUALIFY_PRIVILEGE").orElseThrow();
// PermissionEntity deletePermission =
// permissionRepository.findByPermiso("DELETE_PRIVILEGE").orElseThrow();
// PermissionEntity updatePermission =
// permissionRepository.findByPermiso("UPDATE_PRIVILEGE").orElseThrow();
// PermissionEntity createPermission =
// permissionRepository.findByPermiso("CREATE_PRIVILEGE").orElseThrow();
// PermissionEntity docentePermission =
// permissionRepository.findByPermiso("DELETE_QUALIFY").orElseThrow();
// PermissionEntity docente2Permission=
// permissionRepository.findByPermiso("UPDATE_QUALIFY").orElseThrow();
// PermissionEntity docente3Permission=
// permissionRepository.findByPermiso("CREATE_QUALIFY").orElseThrow();
// PermissionEntity docente4Permission=
// permissionRepository.findByPermiso("READ_QUALIFY").orElseThrow();
